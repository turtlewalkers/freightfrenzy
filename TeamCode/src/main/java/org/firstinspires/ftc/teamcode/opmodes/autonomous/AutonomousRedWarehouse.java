...
public class AutonomousRedWarehouse extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        EncoderDrive(turtlerobot, turtlerobot.TURN_SPEED, -4, -4, 4, 4, 3); //left
        EncoderDrive(turtlerobot,turtlerobot.DRIVE_SPEED, 7, 7, 7, 7, 5);
        arm(turtlerobot, turtlerobot.DRIVE_SPEED, -(duckPos*10), 3);
        if (duckPos == 3) {
            EncoderDrive(turtlerobot, turtlerobot.DRIVE_SPEED, 2, 2, 2, 2, 0.5);
        }
        collectdrop(turtlerobot, false, true);
        EncoderDrive(turtlerobot,turtlerobot.DRIVE_SPEED, -3, -3, -3, -3, 6);
        EncoderDrive(turtlerobot, turtlerobot.TURN_SPEED, -7, -7, 7, 7, 3); //right
        EncoderDrive(turtlerobot,turtlerobot.FAST_SPEED, -50, -50, -50, -50, 4);
        EncoderDrive(turtlerobot, turtlerobot.FAST_SPEED, -20, -20, 20, 20, 3); //right
    }
        ...
        if (recognitions.size() == 0) {
            ...
            for (Recognition recognition_item : recognitions) {
                ...
                if (recognition.getLabel().equals("Duck")) {
                    displayInfo(index);
                    telemetry.addData("leftVal", recognition.getLeft());
