...
public class AutonomousBlueStorageUnit extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        EncoderDrive(turtlerobot,turtlerobot.DRIVE_SPEED, 7, 7, 7, 7, 3); //this needs to be adjusted in the competition
        EncoderDrive(turtlerobot, turtlerobot.TURN_SPEED, -4.5, -4.5, 4.5, 4.5, 3); //left
        EncoderDrive(turtlerobot,turtlerobot.DRIVE_SPEED, 15, 15, 15, 15, 5);  // S1: Forward 47 Inches with 5 Sec timeout
        ...
        EncoderDrive(turtlerobot, 0.25, -7, -7, 7, 7, 3); //right
        EncoderDrive(turtlerobot, turtlerobot.DRIVE_SPEED, -24, -24, -24, -24, 5);
        EncoderDrive(turtlerobot, 0.25, 8, 8, -8, -8, 3); //left
        EncoderDrive(turtlerobot, turtlerobot.DRIVE_SPEED, -10, -10, -10, -10, 5);

        while(counter != 6) {
            startCarousel(turtlerobot, true);
            sleep(500);
            EncoderDrive(turtlerobot, turtlerobot.SLOW_SPEED, -0.3, -0.3, -0.3, -0.3, 1);
            counter += 1;
        ...
        EncoderDrive(turtlerobot, turtlerobot.TURN_SPEED, 3, 3, -12, -12, 3);
        EncoderDrive(turtlerobot, turtlerobot.DRIVE_SPEED, 10, 10, 10, 10, 5);
