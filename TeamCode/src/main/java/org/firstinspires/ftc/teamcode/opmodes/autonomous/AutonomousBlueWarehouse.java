...
public class AutonomousBlueWarehouse extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        EncoderDrive(turtlerobot, 0.25, 4, 4, -4, -4, 1); //right
        EncoderDrive(turtlerobot,turtlerobot.DRIVE_SPEED, 11, 11, 11, 11, 5);
        arm(turtlerobot, 0.25, -(duckPos*10), 3);
        if (duckPos == 3) {
        ...
        EncoderDrive(turtlerobot, turtlerobot.TURN_SPEED, 7, 7, -7, -7, 3); //left
